document.addEventListener("DOMContentLoaded", function () {
    ...
    async function cargarCategorias() {
        const url = herramientasBtn.classList.contains('active')
            ? 'http://localhost:5500/categoria_herramientas'
            : 'http://localhost:5500/categoria_consumibles';
    ...
    async function cargarSubcategorias() {
        ...
        if (!categoriaId) {
            url = herramientasBtn.classList.contains('active')
                ? 'http://localhost:5500/subcategorias_herramientas'
                : 'http://localhost:5500/subcategorias_consumibles';
        } else {
            url = herramientasBtn.classList.contains('active')
                ? `http://localhost:5500/subcategorias_herramientas?categoria_id=${categoriaId}`
                : `http://localhost:5500/subcategorias_consumibles?categoria_id=${categoriaId}`;
        }
    ...
    async function cargarTiposHerramienta() {
        ...
        let url = 'http://localhost:5500/tipos_herramienta';
